public class programmtest {
	...
	public static void main(String[] args) {
		...
		// hier Zahl eingeben
		String inttobinaer = SimpleIO.getString("Bitte eine ganze Zahl eingeben");
		...
		System.out.println("zweiCompliment:\t"+zweiCompliment);
			 ...
			 inttobinaer = SimpleIO.getString("Bitte eine ganze Zahl eingeben");
		//		
		//		
		...
		//		
		//	
				SimpleIO.output(inttobinaer ,"Ausgabe");
